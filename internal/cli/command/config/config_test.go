...
func TestConfigCmdHelp(t *testing.T) {
	...
	assert.Equal(t, "octavius kubeconfig [flags]", testConfigCmd.Example)
}
...
func TestConfigCmdForConfigFileNotExist(t *testing.T) {
	...
	mockFileUtil.On("IsFileExist", "job_data_example/kubeconfig/octavius_client.yaml").Return(false).Once()
	mockFileUtil.On("CreateDirIfNotExist", "./job_data_example/kubeconfig").Return(nil).Once()
...
func TestConfigCmdForConfigFileNotExistForDirectoryCreationFailure(t *testing.T) {
	...
	mockFileUtil.On("IsFileExist", "job_data_example/kubeconfig/octavius_client.yaml").Return(false).Once()
	mockFileUtil.On("CreateDirIfNotExist", "./job_data_example/kubeconfig").Return(errors.New("failed to create directory")).Once()
...
func TestConfigCmdForConfigFileNotExistForConfigFileCreationFailure(t *testing.T) {
	...
	mockFileUtil.On("IsFileExist", "job_data_example/kubeconfig/octavius_client.yaml").Return(false).Once()
	mockFileUtil.On("CreateDirIfNotExist", "./job_data_example/kubeconfig").Return(nil).Once()
	mockFileUtil.On("CreateFile", "job_data_example/kubeconfig/octavius_client.yaml").Return(errors.New("failed to create file")).Once()
...
func TestConfigCmdForConfigFileExist(t *testing.T) {
	...
	mockFileUtil.On("IsFileExist", "job_data_example/kubeconfig/octavius_client.yaml").Return(true).Once()
	mockFileUtil.On("ReadFile", "job_data_example/kubeconfig/octavius_client.yaml").Return("old content", nil).Once()
...
func TestConfigCmdForConfigFileExistForOldFileReadingFailure(t *testing.T) {
	...
	mockFileUtil.On("IsFileExist", "job_data_example/kubeconfig/octavius_client.yaml").Return(true).Once()
	mockFileUtil.On("ReadFile", "job_data_example/kubeconfig/octavius_client.yaml").Return("", errors.New("failed to read file")).Once()
