...
var file_internal_pkg_protofiles_client_cp_job_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_internal_pkg_protofiles_client_cp_job_messages_proto_goTypes = []interface{}{
	...
	nil,                          // 6: RequestForExecute.JobDataEntry
	(*ClientInfo)(nil),           // 7: ClientInfo
}
var file_internal_pkg_protofiles_client_cp_job_messages_proto_depIdxs = []int32{
	7, // 0: RequestForStreamLog.client_info:type_name -> ClientInfo
	7, // 1: RequestForGetJobList.client_info:type_name -> ClientInfo
	7, // 2: RequestForExecute.client_info:type_name -> ClientInfo
	6, // 3: RequestForExecute.job_data:type_name -> RequestForExecute.JobDataEntry
