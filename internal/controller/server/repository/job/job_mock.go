...
func (m *JobMock) Save(ctx context.Context, jobID uint64, jobContext *clientCPproto.RequestForExecute) error {
	args := m.Called(jobID, jobContext)
	return args.Error(0)
}
...
func (m *JobMock) CheckJobMetadataIsAvailable(ctx context.Context, jobName string) (bool, error) {
